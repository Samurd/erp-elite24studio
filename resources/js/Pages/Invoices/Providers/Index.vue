...
const applyFilters = () => {
    router.get(route('finances.invoices.providers.index'), {
        search: search.value,
...
<template>
    <AppLayout title="Facturas de Proveedores">
        <div class="p-6">
            <!-- Header -->
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Cuentas de cobro emitidas por contratistas</p>
                    </div>
                    <Link
                        :href="route('finances.invoices.providers.create')"
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="invoice in invoices.data" :key="invoice.id" class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <Link
                                        :href="route('finances.invoices.providers.show', invoice.id)"
