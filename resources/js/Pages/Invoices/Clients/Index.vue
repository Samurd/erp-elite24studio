...
const applyFilters = () => {
    router.get(route('finances.invoices.clients.index'), {
        search: search.value,
...
<template>
    <AppLayout title="Facturas a Clientes - DIAN">
        <div class="p-6">
            <!-- Header -->
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800">Facturas a Clientes - DIAN</h1>
                        <p class="text-gray-600 mt-1">Facturación desde la DIAN para clientes</p>
                    </div>
                    <Link
                        :href="route('finances.invoices.clients.create')"
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="invoice in invoices.data" :key="invoice.id" class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <Link
                                        :href="route('finances.invoices.clients.show', invoice.id)"
