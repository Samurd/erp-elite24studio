...
import PunchItemForm from './Partials/PunchItemForm.vue';
...
<template>
    <Head title="Nuevo Punch Item" />

    <AppLayout title="Nuevo Punch Item">
        <template #header>
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">
                        Complete los datos para registrar un nuevo Punch Item
                    </p>
                    <div class="mt-2">
