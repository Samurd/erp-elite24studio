<div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Nueva Política</h1>
                <p class="text-gray-600 mt-1">Crear una nueva política en el sistema</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <form wire:submit="save">
            ...
            @livewire('modules.cloud.components.model-attachments-creator', [
                'modelClass' => \App\Models\Policy::class,
                'areaSlug' => 'politicas'
            ])
