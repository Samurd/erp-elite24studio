<div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Crear Voluntario</h1>
                <p class="text-gray-600 mt-1">Registrar nuevo voluntario en el sistema</p>
            </div>
        ...
        <form wire:submit.prevent="save">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                @livewire('modules.cloud.components.model-attachments-creator', [
                    'modelClass' => \App\Models\Volunteer::class,
                    'areaSlug' => 'donaciones'
                ])
            </div>
            ...
            <div class="flex justify-end space-x-3 mt-8">
                ...
                <button type="submit"
                    ...
                    <i class="fas fa-save mr-2"></i>Guardar Voluntario
                </button>
            </div>
        </form>
    </div>
