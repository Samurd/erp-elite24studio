<div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Nueva Donación</h1>
                <p class="text-gray-600 mt-1">Registrar una nueva donación en el sistema</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <form wire:submit="save">
            ...
            @livewire('modules.cloud.components.model-attachments-creator', [
                'modelClass' => \App\Models\Donation::class,
                'areaSlug' => 'donaciones'
            ])
            ...
            <div class="flex justify-end space-x-3 mt-6">
                ...
                <button type="submit"
                    ...
                    <i class="fas fa-save mr-2"></i>Guardar Donación
                </button>
            </div>
        </form>
    </div>
