                ...
                <div class="bg-gray-50 border rounded-lg p-4 shadow-sm">
                    ...
                    <div class="flex flex-wrap gap-3 mt-3 text-sm">
                        ...
                        <div class="flex items-center gap-1">
                            ...
                            <span class="font-medium text-gray-800">
                                {{ $certificate->type?->name ?? 'Sin tipo asignado' }}
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4 text-sm">
                        ...
                        <div>
                            ...
                            <span class="font-medium text-gray-800">
                                {{ $certificate->expires_at ? \Carbon\Carbon::parse($certificate->expires_at)->format('d/m/Y') : 'N/A' }}
                            </span>
                        </div>
                        ...
                        <div>
                            ...
                            <span class="font-medium text-gray-800">
                                {{ $certificate->assignedTo?->name ?? 'Sin asignar' }}
                            </span>
                        </div>
                    </div>
                </div>
