<div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Facturas de Proveedores</h1>
                <p class="text-gray-600 mt-1">Gestión de facturas de proveedores</p>
                <p class="text-sm text-gray-500 mt-1">
                    <i class="fas fa-info-circle mr-1"></i>
                    Solo se muestran contactos con tipo de relación: <span class="font-semibold">Proveedor</span>
                </p>
            </div>
            <div class="flex space-x-3">
                <a href="{{ route('finances.invoices.providers.create') }}"
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="Código o Proveedor..."
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <a href="{{ route('finances.invoices.providers.show', $invoice->id) }}"
                                        class="text-green-600 hover:text-green-900" title="Ver">
                                        <i class="fa-solid fa-eye mr-1"></i> Ver
                                    </a>
                                    <a href="{{ route('finances.invoices.providers.edit', $invoice->id) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                                No se encontraron facturas de proveedores
                            </td>
                        </tr>
                    @endforelse
                </tbody>
