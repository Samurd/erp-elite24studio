    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">
                {{ isset($billingAccount) ? 'Editar Cuenta de Cobro' : 'Nueva Cuenta de Cobro' }}
            </h1>
        </div>
        ...
        <form wire:submit="save" class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Fecha -->
                <div>
                    <label for="invoice_date" class="block text-sm font-medium text-gray-700 mb-2">Fecha</label>
                ...
                <!-- Cliente -->
                <div>
                    <label for="contact_id" class="block text-sm font-medium text-gray-700 mb-2">Cliente</label>
                    ...
                    <p class="text-xs text-gray-500 mt-1">
                        ...
                        Solo contactos con tipo de relación: <span class="font-semibold">Cliente</span>
                    </p>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description" wire:model="form.description" rows="3"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"
                        placeholder="Descripción de la cuenta de cobro..."></textarea>
            ...
            <div class="flex justify-end gap-3">
                <a href="{{ route('finances.invoices.clients.billing-accounts.index') }}" class="btn btn-neutral">
                    Cancelar
                </a>
