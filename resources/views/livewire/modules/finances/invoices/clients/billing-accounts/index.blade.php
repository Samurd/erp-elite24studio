<div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Cuentas de Cobro de Clientes</h1>
                <p class="text-gray-600 mt-1">Gestión de cuentas de cobro de clientes</p>
            ...
            <div class="flex space-x-3">
                <a href="{{ route('finances.invoices.clients.billing-accounts.create') }}"
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <a href="{{ route('finances.invoices.clients.billing-accounts.show', $invoice->id) }}"
                                        class="text-green-600 hover:text-green-900" title="Ver">
                                        <i class="fa-solid fa-eye mr-1"></i> Ver
                                    </a>
                                    <a href="{{ route('finances.invoices.clients.billing-accounts.edit', $invoice->id) }}"
                                        class="text-blue-600 hover:text-blue-900" title="Editar">
                                        <i class="fa-solid fa-pen-to-square mr-1"></i> Editar
                                    </a>
                                    <button wire:click="delete({{ $invoice->id }})"
                                        wire:confirm="¿Estás seguro de que quieres eliminar esta cuenta de cobro?"
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                                No se encontraron cuentas de cobro de clientes
                            </td>
                        </tr>
                    @endforelse
                </tbody>
