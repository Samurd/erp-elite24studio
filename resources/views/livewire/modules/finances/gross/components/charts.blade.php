<div class="space-y-6">
    ...
    <div class="bg-[#252525] text-white p-4 rounded-xl shadow-md">
        <div class="flex justify-between items-center mb-3">
            <h3 class="text-sm font-semibold">Ingreso Bruto por Mes–Año</h3>
    ...
    <div class="bg-[#252525] text-white p-4 rounded-xl shadow-md">
        <div class="flex justify-between items-center mb-3">
            <h3 class="text-sm font-semibold">Ingreso Bruto por Categoría (Mes)</h3>
    ...
    <div class="bg-[#252525] text-white p-4 rounded-xl shadow-md">
        <div class="flex justify-between items-center mb-3">
            <h3 class="text-sm font-semibold">TOP 5 Proyectos por Ingreso</h3>
            ...
            <tbody>
                @forelse($topProjects as $i)
                    <tr class="border-b border-gray-800 hover:bg-gray-800/50">
                        ...
                        <td class="p-2 text-green-400 text-center">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center text-gray-500 py-2">No hay datos</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const initialChart1Data = @json(array_values($grossByMonth));
        const initialChart2Labels = @json(array_keys($grossByCategory));
        const initialChart2Data = @json(array_values($grossByCategory));
