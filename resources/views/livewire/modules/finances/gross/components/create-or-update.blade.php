<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-2xl shadow-lg p-6">
        <div class="flex border-b pb-4 mb-4">
            <h3 class="text-xl font-bold">{{ isset($income) ? 'Actualizar Ingreso' : 'Añadir nuevo Ingreso' }}</h3>
        </div>

        <div id="incomeForm" class="flex flex-col gap-4">

            <!-- Nombre -->
            <div class="mb-3">
                <label for="name" class="block font-semibold mb-1">Nombre</label>
                <x-input id="name" type="text" name="nombre_politica" class="w-full" placeholder="Nombre"
        ...
        <div class="flex justify-end mt-6 pt-4 border-t">
            <x-button href="{{ route('finances.gross.index') }}" wire:navigate
