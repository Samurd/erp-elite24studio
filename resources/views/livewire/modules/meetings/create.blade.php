<div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Nueva Reunión</h1>
                <p class="text-gray-600 mt-1">Crear una nueva reunión en el sistema</p>
            </div>
        ...
        <form wire:submit="save">
            ...
            <div class="mt-8 flex justify-end space-x-3">
                ...
                <button type="submit"
                    ...
                    <i class="fas fa-save mr-2"></i>Guardar Reunión
                </button>
            </div>
        </form>
    </div>
