    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="Título o Descripción..."
                    ...
                    @forelse($reports as $report)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="text-xs text-gray-500">
                                    {{ $report->hour ? \Carbon\Carbon::parse($report->hour)->format('H:i') : '' }}
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($report->status)
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    ...
                                    <button wire:click="delete({{ $report->id }})"
                                        wire:confirm="¿Estás seguro de que quieres eliminar este reporte?"
