    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-600 mt-1">Gestión de eventos de marketing</p>
            </div>
                    ...
                    @forelse($events as $event)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($event->status)
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full
                                        @if($event->status->name == 'Planificado') bg-blue-100 text-blue-800
                                        @elseif($event->status->name == 'Confirmado') bg-green-100 text-green-800
                                        @elseif($event->status->name == 'En Progreso') bg-yellow-100 text-yellow-800
                                        @elseif($event->status->name == 'Ejecutado') bg-teal-100 text-teal-800
                                        @elseif($event->status->name == 'Cancelado') bg-red-100 text-red-800
                                        @elseif($event->status->name == 'Postergado') bg-purple-100 text-purple-800
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="text-sm text-gray-900">
                                    {{ App\Services\MoneyFormatterService::format($event->items->sum('total_price')) }}
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    ...
                                    <a href="{{ route('marketing.events.edit', $event->id) }}"
