    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="ID o Contacto..."
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($quotes as $quote)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    {{ $quote->issued_at ? \Carbon\Carbon::parse($quote->issued_at)->format('d/m/Y') : '-' }}
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($quote->status)
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    ...
                                    <button wire:click="delete({{ $quote->id }})"
                                        wire:confirm="¿Estás seguro de que quieres eliminar esta cotización?"
                ...
                <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                    <div>
                        <p class="text-sm text-gray-700">
                            Mostrando
                            <span class="font-medium">{{ $quotes->firstItem() }}</span>
                            a
                            <span class="font-medium">{{ $quotes->lastItem() }}</span>
                            de
