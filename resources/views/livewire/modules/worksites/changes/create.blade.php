        ...
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">
                    {{ isset($change) ? 'Editar Cambio' : 'Nuevo Cambio' }}
                </h1>
                <p class="text-gray-600 mt-1">
                    {{ isset($change) ? 'Actualiza la información del cambio' : 'Complete los datos para registrar un nuevo cambio' }}
                </p>
                <div class="mt-2">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <form wire:submit.prevent="save">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Fecha de Cambio -->
                <div>
                    <label for="change_date" class="block text-sm font-medium text-gray-700 mb-2">Fecha de Cambio *</label>
                    <input type="date" id="change_date" wire:model="form.change_date"
                ...
                <!-- Tipo de Cambio -->
                <div>
                    <label for="change_type_id" class="block text-sm font-medium text-gray-700 mb-2">Tipo de Cambio *</label>
                ...
                <div>
                    ...
                    <input type="text" id="requested_by" wire:model="form.requested_by"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"
                ...
                <div>
                    ...
                    <select id="budget_impact_id" wire:model="form.budget_impact_id"
                        ...
                        @foreach($budgetImpactOptions as $budgetImpact)
                            <option value="{{ $budgetImpact->id }}">{{ $budgetImpact->name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="grid grid-cols-1 gap-6 mt-6">
                <div>
                    ...
                    <textarea id="description" wire:model="form.description" rows="6"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"
                              placeholder="Descripción detallada del cambio..."></textarea>
                ...
                <div>
                    <label for="internal_notes" class="block text-sm font-medium text-gray-700 mb-2">Observaciones Internas</label>
                    <textarea id="internal_notes" wire:model="form.internal_notes" rows="4"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"
            ...
            <div class="flex justify-end space-x-3 mt-8 pt-6 border-t">
                ...
                <button type="submit"
                    ...
                    <i class="fas fa-save mr-2"></i>{{ isset($change) ? 'Actualizar' : 'Guardar' }} Cambio
                </button>
            </div>
        </form>
    </div>
