<x-guest-layout>
    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}" class="w-full p-4" x-data="{ loading: false }"
            @submit="loading = true">
            @csrf
            ...
            <div class="mt-4">
                ...
                <div class="bg-gray-500/20 rounded-md relative">
                    ...
                    <button type="button"
                        ...
                        <svg id="password-eye-icon" class="w-5 h-5" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
            ...
            <div class="flex flex-col items-center justify-center mt-4">
                ...
                <x-button
                    class="w-full bg-black hover:bg-gray-900 text-black font-semibold py-3 transition mt-4 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
                    ::disabled="loading">
