...
use App\Livewire\Forms\Modules\Finances\Invoices\Clients\Form;
...
class Create extends Component
{
    ...
    public function save()
    {
        ...
        $invoiceName = "Factura cliente: " . $invoice->code;
    ...
    public function render()
    {
        ...
        return view('livewire.modules.finances.invoices.clients.create', [
